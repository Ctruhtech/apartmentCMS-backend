...
apartmentRouter.get("/models/:id", async(req: Request, res: Response) => {
    try {
        ...
        const filteredResponse = {
            ...
            type: document.type,
            isModelFlipY: document.isModelFlipY,
            ...
            modelLogoUrl: document.modelLogoUrl,
...
apartmentRouter.put("/models/:id/model/:modelId", async (req: Request, res: Response) => {
    try {
      ...
      const filteredResponse = {
        ...
        isModelFlipY: existingEntry.isModelFlipY,
        ...
        modelLogoUrl: existingEntry.modelLogoUrl,
